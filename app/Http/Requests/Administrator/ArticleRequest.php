...
use Wanglelecc\Laracms\Http\Requests\Administrator\ArticleRequest as ParentArticleRequest;

class ArticleRequest extends ParentArticleRequest
{
            ...
            case 'POST':
                {
                    return [
                        ...
                        'link' => 'nullable|alpha_dash|unique:articles|max:191',
                    ];
                }
            // UPDATE
            case 'PUT':
